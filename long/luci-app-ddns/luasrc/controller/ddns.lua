...
function index()
	...
	entry( {"admin", "ddns", "ddns"}, cbi("ddns/overview"), _("Dynamic DNS"), 59)
	entry( {"admin", "ddns", "ddns", "detail"}, cbi("ddns/detail"), nil ).leaf = true
	entry( {"admin", "ddns", "ddns", "hints"}, cbi("ddns/hints",
		{hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), nil ).leaf = true
	entry( {"admin", "ddns", "ddns", "global"}, cbi("ddns/global"), nil ).leaf = true
	entry( {"admin", "ddns", "ddns", "logview"}, call("logread") ).leaf = true
	entry( {"admin", "ddns", "ddns", "startstop"}, post("startstop") ).leaf = true
	entry( {"admin", "ddns", "ddns", "status"}, call("status") ).leaf = true
end
...
function app_title_back()
	local tmp = {}
	tmp[#tmp+1] = 	[[<a href="]]
	tmp[#tmp+1] =	DISP.build_url("admin", "ddns", "ddns")
	tmp[#tmp+1] =	[[">]]
